...
class Index : public Printable {
 ...
 public:
  ...
  /**
   * Perform a scan using a predicate
   *
  ...
  /**
   * @copydoc Index::Scan()
   * This is a scan version used only for testing. Since it does scan planning
   * every time, it is slow, and should only be used for correctness testing.
   */
  ...
  /**
   * Scan all values for the given key in the index
   *
   * @param[out] result Where the results of the scan are stored
   */
